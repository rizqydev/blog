    ...
    <>
      ...
      <div
        className="
          prose 
          prose-slate
          mb-4 prose-p:text-justify prose-table:w-max dark:prose-h2:text-slate-200 prose-h4:dark:text-slate-100 dark:prose-p:text-slate-300
          prose-a:dark:text-slate-100 
