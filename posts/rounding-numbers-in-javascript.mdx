...
In javascript you can manipulate numbers by rounding them to the nearest integer using several functions. 
Below are some functions along with the explanations:
